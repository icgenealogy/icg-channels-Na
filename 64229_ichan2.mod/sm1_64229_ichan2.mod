...
PARAMETER
{
  ...
  ah = -0.14591407553375205     (/mV) 
  bh = 6.938754634625489     (1) 
  ...
  anf = 0.1234621055801908     (/mV) 
  bnf = -3.27209428537909     (1) 
  ...
  am = 0.12492608066465888     (/mV) 
  bm = -3.6229473603431543     (1) 
  ...
  ans = 0.1234647468210501     (/mV) 
  bns = -4.753693769494797     (1) 
