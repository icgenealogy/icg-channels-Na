...
PARAMETER
{
  ...
  ah = -0.1459140755733403     (/mV) 
  bh = 6.938754636526843     (1) 
  ...
  anf = 0.12346210913748909     (/mV) 
  bnf = -3.272094405330788     (1) 
  ...
  am = 0.12492610843084037     (/mV) 
  bm = -3.622948165881958     (1) 
  ...
  ans = 0.12346474554088605     (/mV) 
  bns = -4.753693711790485     (1) 
