...
PARAMETER
{
  ...
  ah = -0.1459140764621858     (/mV) 
  bh = 6.938754683286357     (1) 
  ...
  anf = 0.12346201448890039     (/mV) 
  bnf = -3.272091257456516     (1) 
  ...
  am = 0.12492608718365947     (/mV) 
  bm = -3.622947549620223     (1) 
  ...
  ans = 0.12346470656725936     (/mV) 
  bns = -4.75369194627608     (1) 
