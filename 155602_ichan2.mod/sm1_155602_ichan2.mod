...
PARAMETER
{
  ...
  ah = -0.14591407668575662     (/mV) 
  bh = 6.938754695078299     (1) 
  ...
  anf = 0.12346211022390713     (/mV) 
  bnf = -3.272094439824126     (1) 
  ...
  am = 0.1249260874147585     (/mV) 
  bm = -3.6229475560246827     (1) 
  ...
  ans = 0.12346467960237364     (/mV) 
  bns = -4.753690726441781     (1) 
