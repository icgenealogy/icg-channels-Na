...
PARAMETER
{
  ...
  ah = -0.14591407663229586     (/mV) 
  bh = 6.938754692223666     (1) 
  ...
  anf = 0.12346196642610409     (/mV) 
  bnf = -3.2720896655666127     (1) 
  ...
  am = 0.12492609840197624     (/mV) 
  bm = -3.6229478745237507     (1) 
  ...
  ans = 0.12346468922939072     (/mV) 
  bns = -4.753693867812491     (1) 
