...
PROCEDURE rates(v(mV) )
{
 alfac = (Oon/Con)^(1/4)
 btfac = (Ooff/Coff)^(1/4) 
 f01 = 4 * alpha * exp((v-shft)/x1)
 f02 = 3 * alpha * exp((v-shft)/x1)
 f03 = 2 * alpha * exp((v-shft)/x1)
 f04 = 1 * alpha * exp((v-shft)/x1)
 f0O = gamma * exp((v-shft)/x3)
 fip = epsilon * exp((v-shft)/x5)
 f11 = 4 * alpha * alfac * exp((v-shft)/x1)
 f12 = 3 * alpha * alfac * exp((v-shft)/x1)
 f13 = 2 * alpha * alfac * exp((v-shft)/x1)
 f14 = 1 * alpha * alfac * exp((v-shft)/x1)
 f1n = gamma * exp((v-shft)/x3)
 fi1 = Con
 fi2 = Con * alfac
 fi3 = Con * alfac^2
 fi4 = Con * alfac^3
 ...
 b01 = 1 * beta * exp((v-shft)/x2)
 b02 = 2 * beta * exp((v-shft)/x2)
 b03 = 3 * beta * exp((v-shft)/x2)
 b04 = 4 * beta * exp((v-shft)/x2)
 b0O = delta * exp((v-shft)/x4)
 bip = zeta * exp((v-shft)/x6)
 b11 = 1 * beta * btfac * exp((v-shft)/x2)
 b12 = 2 * beta * btfac * exp((v-shft)/x2)
 b13 = 3 * beta * btfac * exp((v-shft)/x2)
 b14 = 4 * beta * btfac * exp((v-shft)/x2)
 b1n = delta * exp((v-shft)/x4)
 bi1 = Coff
 bi2 = Coff * btfac
 bi3 = Coff * btfac^2
 bi4 = Coff * btfac^3
