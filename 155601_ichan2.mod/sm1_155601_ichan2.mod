...
PARAMETER
{
  ...
  ah = -0.1459140763510908     (/mV) 
  bh = 6.938754677408834     (1) 
  ...
  anf = 0.12346204787863697     (/mV) 
  bnf = -3.2720923668204223     (1) 
  ...
  am = 0.12492611388325948     (/mV) 
  bm = -3.6229483237242968     (1) 
  ...
  ans = 0.12346471061031343     (/mV) 
  bns = -4.753692128393191     (1) 
