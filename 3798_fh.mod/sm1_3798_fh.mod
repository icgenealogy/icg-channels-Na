...
PARAMETER
{
  ...
  am = 0.10378574338816332     (/mV) 
  bm = -3.486413600668117     (1) 
  ...
  ap = 0.07498851417095453     (/mV) 
  bp = -0.9117187866991537     (1) 
  ...
  an = 0.11896137974167958     (/mV) 
  bn = -4.737712955417811     (1) 
  ...
  ah = -0.2148864745878057     (/mV) 
  bh = 13.481433125827602     (1) 
