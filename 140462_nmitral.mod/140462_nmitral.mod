...
PARAMETER {
	...
	thm1  = -60.3833	(mV)		: v 1/2 for act		(-42)
	thm2  = -11.8432	(mV)		: v 1/2 for act		(-15)
	Am1   = 0.242621	(/ms)		: open (v)		
	Am2   = 0.819229	(/ms)		: close (v)		
	qm1   = 3.51809		(mV)		: act slope		
	qm2   = 3.9834		(mV)		: act slope		

	thi1  = -29.1689	(mV)		: v 1/2 for inact 	
	thi2  = -28.4483	(mV)		: v 1/2 for inact 	
	qi   = 5.63879		(mV)	        : inact tau slope
	thinf = -38.1801	(mV)		: inact inf slope	
