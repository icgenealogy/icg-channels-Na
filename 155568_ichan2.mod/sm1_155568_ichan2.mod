...
PARAMETER
{
  ...
  ah = -0.14591407704403062     (/mV) 
  bh = 6.938754713821574     (1) 
  ...
  anf = 0.12346210259591364     (/mV) 
  bnf = -3.272094186465562     (1) 
  ...
  am = 0.12492608327930986     (/mV) 
  bm = -3.6229474361910783     (1) 
  ...
  ans = 0.12346470406033926     (/mV) 
  bns = -4.753691831829156     (1) 
